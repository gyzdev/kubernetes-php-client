...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\ConfigMapList as ConfigMapList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\ConfigMap as TheConfigMap;
...
class ConfigMap extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\ConfigMap $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheConfigMap|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\ConfigMap $Model)
    {
        return $this->parseResponse(
