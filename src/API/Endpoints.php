...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\EndpointsList as EndpointsList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\Endpoints as TheEndpoints;
...
class Endpoints extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\Endpoints $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheEndpoints|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\Endpoints $Model)
    {
        return $this->parseResponse(
