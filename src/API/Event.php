...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\EventList as EventList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\Event as TheEvent;
...
class Event extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\Event $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheEvent|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\Event $Model)
    {
        return $this->parseResponse(
