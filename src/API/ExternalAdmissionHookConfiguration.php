...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Admissionregistration\V1alpha1\ExternalAdmissionHookConfigurationList as ExternalAdmissionHookConfigurationList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Admissionregistration\V1alpha1\ExternalAdmissionHookConfiguration as TheExternalAdmissionHookConfiguration;
...
class ExternalAdmissionHookConfiguration extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Admissionregistration\V1alpha1\ExternalAdmissionHookConfiguration $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheExternalAdmissionHookConfiguration|mixed
     */
    public function replace($name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Admissionregistration\V1alpha1\ExternalAdmissionHookConfiguration $Model)
    {
        return $this->parseResponse(
