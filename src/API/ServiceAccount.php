...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\ServiceAccountList as ServiceAccountList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\ServiceAccount as TheServiceAccount;
...
class ServiceAccount extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\ServiceAccount $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheServiceAccount|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\ServiceAccount $Model)
    {
        return $this->parseResponse(
