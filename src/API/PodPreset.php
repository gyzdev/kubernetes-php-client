...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Settings\V1alpha1\PodPresetList as PodPresetList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Settings\V1alpha1\PodPreset as ThePodPreset;
...
class PodPreset extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Settings\V1alpha1\PodPreset $Model)
    {
        return $this->parseResponse(
     ...
     * @return ThePodPreset|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Settings\V1alpha1\PodPreset $Model)
    {
        return $this->parseResponse(
