...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\PodList as PodList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\Pod as ThePod;
...
class Pod extends \Kubernetes\AbstractAPI
{
     ...
     * @return ThePod|mixed
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\Pod $Model)
    {
        return $this->parseResponse(
     ...
     * @return ThePod|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\Pod $Model)
    {
        return $this->parseResponse(
     ...
     * @return ThePod|mixed
     */
    public function replaceStatus($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\Pod $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/api/v1/namespaces/{$namespace}/pods/{$name}/status"
