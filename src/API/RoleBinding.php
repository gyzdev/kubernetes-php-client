...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Rbac\V1alpha1\RoleBindingList as RoleBindingList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Rbac\V1alpha1\RoleBinding as TheRoleBinding;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Status as Status;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions as DeleteOptions;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch as Patch;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\WatchEvent as WatchEvent;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Rbac\V1beta1\RoleBindingList as RoleBindingListV1beta1;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Rbac\V1beta1\RoleBinding as TheRoleBindingV1beta1;
...
class RoleBinding extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function createRbacAuthorizationV1alpha1($namespace = 'default', \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Rbac\V1alpha1\RoleBinding $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheRoleBinding|mixed
     */
    public function replaceRbacAuthorizationV1alpha1($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Rbac\V1alpha1\RoleBinding $Model)
    {
        return $this->parseResponse(
     ...
     */
    public function createRbacAuthorizationV1beta1($namespace = 'default', \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Rbac\V1beta1\RoleBinding $Model)
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{$namespace}/rolebindings"
     ...
     * @return TheRoleBindingV1beta1|mixed
     */
    public function replaceRbacAuthorizationV1beta1($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Rbac\V1beta1\RoleBinding $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{$namespace}/rolebindings/{$name}"
