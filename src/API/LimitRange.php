...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\LimitRangeList as LimitRangeList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\LimitRange as TheLimitRange;
...
class LimitRange extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\LimitRange $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheLimitRange|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\LimitRange $Model)
    {
        return $this->parseResponse(
