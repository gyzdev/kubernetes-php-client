...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\PodTemplateList as PodTemplateList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\PodTemplate as ThePodTemplate;
...
class PodTemplate extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\PodTemplate $Model)
    {
        return $this->parseResponse(
     ...
     * @return ThePodTemplate|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\PodTemplate $Model)
    {
        return $this->parseResponse(
