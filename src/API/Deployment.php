...
use \Kubernetes\Model\Io\K8s\Api\Apps\V1beta1\Deployment as TheDeployment;
...
use \Kubernetes\Model\Io\K8s\Api\Extensions\V1beta1\DeploymentList as DeploymentListV1beta1;
use \Kubernetes\Model\Io\K8s\Api\Extensions\V1beta1\Deployment as TheDeploymentV1beta1;
...
class Deployment extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Api\Apps\V1beta1\Deployment $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheDeployment|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1beta1\Deployment $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheDeployment|mixed
     */
    public function replaceStatus($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1beta1\Deployment $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apps/v1beta1/namespaces/{$namespace}/deployments/{$name}/status"
