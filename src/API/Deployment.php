...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Apps\V1beta1\DeploymentList as DeploymentList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Apps\V1beta1\Deployment as TheDeployment;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Status as Status;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions as DeleteOptions;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch as Patch;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\WatchEvent as WatchEvent;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Extensions\V1beta1\DeploymentList as DeploymentListV1beta1;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Extensions\V1beta1\Deployment as TheDeploymentV1beta1;
...
class Deployment extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Apps\V1beta1\Deployment $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheDeployment|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Apps\V1beta1\Deployment $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheDeployment|mixed
     */
    public function replaceStatus($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Apps\V1beta1\Deployment $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apps/v1beta1/namespaces/{$namespace}/deployments/{$name}/status"
     ...
     */
    public function createExtensionsV1beta1($namespace = 'default', \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Extensions\V1beta1\Deployment $Model)
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/extensions/v1beta1/namespaces/{$namespace}/deployments"
     ...
     * @return TheDeploymentV1beta1|mixed
     */
    public function replaceExtensionsV1beta1($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Extensions\V1beta1\Deployment $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/extensions/v1beta1/namespaces/{$namespace}/deployments/{$name}"
     ...
     * @return TheDeploymentV1beta1|mixed
     */
    public function replaceStatusExtensionsV1beta1($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Extensions\V1beta1\Deployment $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/extensions/v1beta1/namespaces/{$namespace}/deployments/{$name}/status"
