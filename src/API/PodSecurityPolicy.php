...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Extensions\V1beta1\PodSecurityPolicyList as PodSecurityPolicyList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Extensions\V1beta1\PodSecurityPolicy as ThePodSecurityPolicy;
...
class PodSecurityPolicy extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Extensions\V1beta1\PodSecurityPolicy $Model)
    {
        return $this->parseResponse(
     ...
     * @return ThePodSecurityPolicy|mixed
     */
    public function replace($name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Extensions\V1beta1\PodSecurityPolicy $Model)
    {
        return $this->parseResponse(
