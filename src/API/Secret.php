...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\SecretList as SecretList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\Secret as TheSecret;
...
class Secret extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\Secret $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheSecret|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\Secret $Model)
    {
        return $this->parseResponse(
