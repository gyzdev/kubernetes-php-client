...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Autoscaling\V1\Scale as TheScale;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch as Patch;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Apps\V1beta1\Scale as TheScaleV1beta1;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Extensions\V1beta1\Scale as TheScaleV1beta1Extensions;
...
class Scale extends \Kubernetes\AbstractAPI
{
     ...
     * @return TheScale|mixed
     */
    public function replaceReplicationController($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Autoscaling\V1\Scale $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheScaleV1beta1|mixed
     */
    public function replaceDeployment($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Apps\V1beta1\Scale $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apps/v1beta1/namespaces/{$namespace}/deployments/{$name}/scale"
     ...
     * @return TheScaleV1beta1Extensions|mixed
     */
    public function replaceDeploymentExtensionsV1beta1($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Extensions\V1beta1\Scale $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/extensions/v1beta1/namespaces/{$namespace}/deployments/{$name}/scale"
     ...
     * @return TheScaleV1beta1Extensions|mixed
     */
    public function replaceReplicaSet($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Extensions\V1beta1\Scale $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/extensions/v1beta1/namespaces/{$namespace}/replicasets/{$name}/scale"
     ...
     * @return TheScaleV1beta1Extensions|mixed
     */
    public function replaceReplicationControllerDummy($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Extensions\V1beta1\Scale $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/extensions/v1beta1/namespaces/{$namespace}/replicationcontrollers/{$name}/scale"
