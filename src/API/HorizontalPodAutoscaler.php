...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Autoscaling\V1\HorizontalPodAutoscalerList as HorizontalPodAutoscalerList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Autoscaling\V1\HorizontalPodAutoscaler as TheHorizontalPodAutoscaler;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Status as Status;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions as DeleteOptions;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch as Patch;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\WatchEvent as WatchEvent;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Autoscaling\V2alpha1\HorizontalPodAutoscalerList as HorizontalPodAutoscalerListV2alpha1;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Autoscaling\V2alpha1\HorizontalPodAutoscaler as TheHorizontalPodAutoscalerV2alpha1;
...
class HorizontalPodAutoscaler extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Autoscaling\V1\HorizontalPodAutoscaler $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheHorizontalPodAutoscaler|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Autoscaling\V1\HorizontalPodAutoscaler $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheHorizontalPodAutoscaler|mixed
     */
    public function replaceStatus($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Autoscaling\V1\HorizontalPodAutoscaler $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/autoscaling/v1/namespaces/{$namespace}/horizontalpodautoscalers/{$name}/status"
     ...
     * list or watch objects of kind HorizontalPodAutoscaler
     *
     * @return HorizontalPodAutoscalerListV2alpha1|mixed
     */
    public function listForAllNamespacesAutoscalingV2alpha1()
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return HorizontalPodAutoscalerListV2alpha1|mixed
     */
    public function listAutoscalingV2alpha1($namespace = 'default', array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     *
     * @param $namespace
     * @param TheHorizontalPodAutoscalerV2alpha1 $Model
     * @return TheHorizontalPodAutoscalerV2alpha1|mixed
     */
    public function createAutoscalingV2alpha1($namespace = 'default', \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Autoscaling\V2alpha1\HorizontalPodAutoscaler $Model)
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/autoscaling/v2alpha1/namespaces/{$namespace}/horizontalpodautoscalers"
     ...
     * @return Status|mixed
     */
    public function deleteCollectionAutoscalingV2alpha1($namespace = 'default', array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/autoscaling/v2alpha1/namespaces/{$namespace}/horizontalpodautoscalers"
     ...
     * @return TheHorizontalPodAutoscalerV2alpha1|mixed
     */
    public function readAutoscalingV2alpha1($namespace = 'default', $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return TheHorizontalPodAutoscalerV2alpha1|mixed
     */
    public function replaceAutoscalingV2alpha1($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Autoscaling\V2alpha1\HorizontalPodAutoscaler $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/autoscaling/v2alpha1/namespaces/{$namespace}/horizontalpodautoscalers/{$name}"
     ...
     * @return Status|mixed
     */
    public function deleteAutoscalingV2alpha1($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/autoscaling/v2alpha1/namespaces/{$namespace}/horizontalpodautoscalers/{$name}"
     ...
     * @return TheHorizontalPodAutoscalerV2alpha1|mixed
     */
    public function patchAutoscalingV2alpha1($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model)
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/autoscaling/v2alpha1/namespaces/{$namespace}/horizontalpodautoscalers/{$name}"
     ...
     * @return TheHorizontalPodAutoscalerV2alpha1|mixed
     */
    public function readStatusAutoscalingV2alpha1($namespace = 'default', $name)
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return TheHorizontalPodAutoscalerV2alpha1|mixed
     */
    public function replaceStatusAutoscalingV2alpha1($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Autoscaling\V2alpha1\HorizontalPodAutoscaler $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/autoscaling/v2alpha1/namespaces/{$namespace}/horizontalpodautoscalers/{$name}/status"
     ...
     * @return TheHorizontalPodAutoscalerV2alpha1|mixed
     */
    public function patchStatusAutoscalingV2alpha1($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model)
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/autoscaling/v2alpha1/namespaces/{$namespace}/horizontalpodautoscalers/{$name}/status"
     ...
     * @return WatchEvent|mixed
     */
    public function watchListForAllNamespacesAutoscalingV2alpha1()
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return WatchEvent|mixed
     */
    public function watchListAutoscalingV2alpha1($namespace = 'default')
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return WatchEvent|mixed
     */
    public function watchAutoscalingV2alpha1($namespace = 'default', $name)
    {
        return $this->parseResponse(
        	$this->client->request('get',
