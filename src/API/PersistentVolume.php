...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\PersistentVolumeList as PersistentVolumeList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\PersistentVolume as ThePersistentVolume;
...
class PersistentVolume extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\PersistentVolume $Model)
    {
        return $this->parseResponse(
     ...
     * @return ThePersistentVolume|mixed
     */
    public function replace($name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\PersistentVolume $Model)
    {
        return $this->parseResponse(
     ...
     * @return ThePersistentVolume|mixed
     */
    public function replaceStatus($name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\PersistentVolume $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/api/v1/persistentvolumes/{$name}/status"
