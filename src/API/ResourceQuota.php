...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\ResourceQuotaList as ResourceQuotaList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\ResourceQuota as TheResourceQuota;
...
class ResourceQuota extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\ResourceQuota $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheResourceQuota|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\ResourceQuota $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheResourceQuota|mixed
     */
    public function replaceStatus($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\ResourceQuota $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/api/v1/namespaces/{$namespace}/resourcequotas/{$name}/status"
