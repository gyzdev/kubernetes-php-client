...
use \Kubernetes\Model\Io\K8s\Api\Apps\V1beta1\StatefulSet as TheStatefulSet;
...
class StatefulSet extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Api\Apps\V1beta1\StatefulSet $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheStatefulSet|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1beta1\StatefulSet $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheStatefulSet|mixed
     */
    public function replaceStatus($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1beta1\StatefulSet $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apps/v1beta1/namespaces/{$namespace}/statefulsets/{$name}/status"
