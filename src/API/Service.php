...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\ServiceList as ServiceList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\Service as TheService;
...
class Service extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\Service $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheService|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\Service $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheService|mixed
     */
    public function replaceStatus($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\Service $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/api/v1/namespaces/{$namespace}/services/{$name}/status"
