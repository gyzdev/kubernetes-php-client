...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\NodeList as NodeList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\Node as TheNode;
...
class Node extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\Node $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheNode|mixed
     */
    public function replace($name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\Node $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheNode|mixed
     */
    public function replaceStatus($name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\Node $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/api/v1/nodes/{$name}/status"
