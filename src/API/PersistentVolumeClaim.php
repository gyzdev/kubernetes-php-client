...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\PersistentVolumeClaimList as PersistentVolumeClaimList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\PersistentVolumeClaim as ThePersistentVolumeClaim;
...
class PersistentVolumeClaim extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\PersistentVolumeClaim $Model)
    {
        return $this->parseResponse(
     ...
     * @return ThePersistentVolumeClaim|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\PersistentVolumeClaim $Model)
    {
        return $this->parseResponse(
     ...
     * @return ThePersistentVolumeClaim|mixed
     */
    public function replaceStatus($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\PersistentVolumeClaim $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/api/v1/namespaces/{$namespace}/persistentvolumeclaims/{$name}/status"
