...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Admissionregistration\V1alpha1\InitializerConfigurationList as InitializerConfigurationList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Admissionregistration\V1alpha1\InitializerConfiguration as TheInitializerConfiguration;
...
class InitializerConfiguration extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Admissionregistration\V1alpha1\InitializerConfiguration $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheInitializerConfiguration|mixed
     */
    public function replace($name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Admissionregistration\V1alpha1\InitializerConfiguration $Model)
    {
        return $this->parseResponse(
