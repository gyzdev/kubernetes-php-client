...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\NamespaceList as NamespaceList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\KubernetesNamespace as TheKubernetesNamespace;
...
class KubernetesNamespace extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\KubernetesNamespace $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheKubernetesNamespace|mixed
     */
    public function replace($name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\KubernetesNamespace $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheKubernetesNamespace|mixed
     */
    public function replaceFinalize($name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\KubernetesNamespace $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
     ...
     * @return TheKubernetesNamespace|mixed
     */
    public function replaceStatus($name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\KubernetesNamespace $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/api/v1/namespaces/{$name}/status"
