...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Batch\V1\JobList as JobList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Batch\V1\Job as TheJob;
...
class Job extends \Kubernetes\AbstractAPI
{
     ...
     * @return TheJob|mixed
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Batch\V1\Job $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheJob|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Batch\V1\Job $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheJob|mixed
     */
    public function replaceStatus($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Batch\V1\Job $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/batch/v1/namespaces/{$namespace}/jobs/{$name}/status"
