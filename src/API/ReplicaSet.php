...
use \Kubernetes\Model\Io\K8s\Api\Apps\V1beta2\ReplicaSet as TheReplicaSet;
...
class ReplicaSet extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Api\Apps\V1beta2\ReplicaSet $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheReplicaSet|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1beta2\ReplicaSet $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheReplicaSet|mixed
     */
    public function replaceStatus($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1beta2\ReplicaSet $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apps/v1beta2/namespaces/{$namespace}/replicasets/{$name}/status"
