...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Policy\V1beta1\PodDisruptionBudgetList as PodDisruptionBudgetList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Policy\V1beta1\PodDisruptionBudget as ThePodDisruptionBudget;
...
class PodDisruptionBudget extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Policy\V1beta1\PodDisruptionBudget $Model)
    {
        return $this->parseResponse(
     ...
     * @return ThePodDisruptionBudget|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Policy\V1beta1\PodDisruptionBudget $Model)
    {
        return $this->parseResponse(
     ...
     * @return ThePodDisruptionBudget|mixed
     */
    public function replaceStatus($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Policy\V1beta1\PodDisruptionBudget $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/policy/v1beta1/namespaces/{$namespace}/poddisruptionbudgets/{$name}/status"
