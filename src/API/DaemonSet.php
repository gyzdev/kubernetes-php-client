...
use \Kubernetes\Model\Io\K8s\Api\Apps\V1beta2\DaemonSet as TheDaemonSet;
...
class DaemonSet extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Api\Apps\V1beta2\DaemonSet $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheDaemonSet|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1beta2\DaemonSet $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheDaemonSet|mixed
     */
    public function replaceStatus($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1beta2\DaemonSet $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apps/v1beta2/namespaces/{$namespace}/daemonsets/{$name}/status"
