...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Storage\V1\StorageClassList as StorageClassList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Storage\V1\StorageClass as TheStorageClass;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Status as Status;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions as DeleteOptions;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch as Patch;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\WatchEvent as WatchEvent;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Storage\V1beta1\StorageClassList as StorageClassListV1beta1;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Storage\V1beta1\StorageClass as TheStorageClassV1beta1;
...
class StorageClass extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Storage\V1\StorageClass $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheStorageClass|mixed
     */
    public function replace($name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Storage\V1\StorageClass $Model)
    {
        return $this->parseResponse(
     ...
     */
    public function createStorageV1beta1(\Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Storage\V1beta1\StorageClass $Model)
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/storage.k8s.io/v1beta1/storageclasses"
     ...
     * @return TheStorageClassV1beta1|mixed
     */
    public function replaceStorageV1beta1($name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Storage\V1beta1\StorageClass $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/storage.k8s.io/v1beta1/storageclasses/{$name}"
