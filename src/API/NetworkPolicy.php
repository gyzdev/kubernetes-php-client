...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Extensions\V1beta1\NetworkPolicyList as NetworkPolicyList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Extensions\V1beta1\NetworkPolicy as TheNetworkPolicy;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Status as Status;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions as DeleteOptions;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch as Patch;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\WatchEvent as WatchEvent;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Networking\V1\NetworkPolicyList as NetworkPolicyListV1;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Networking\V1\NetworkPolicy as TheNetworkPolicyV1;
...
class NetworkPolicy extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Extensions\V1beta1\NetworkPolicy $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheNetworkPolicy|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Extensions\V1beta1\NetworkPolicy $Model)
    {
        return $this->parseResponse(
     ...
     */
    public function createNetworkingV1($namespace = 'default', \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Networking\V1\NetworkPolicy $Model)
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/networking.k8s.io/v1/namespaces/{$namespace}/networkpolicies"
     ...
     * @return TheNetworkPolicyV1|mixed
     */
    public function replaceNetworkingV1($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Networking\V1\NetworkPolicy $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/networking.k8s.io/v1/namespaces/{$namespace}/networkpolicies/{$name}"
