...
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Certificates\V1beta1\CertificateSigningRequestList as CertificateSigningRequestList;
use \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Certificates\V1beta1\CertificateSigningRequest as TheCertificateSigningRequest;
...
class CertificateSigningRequest extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Certificates\V1beta1\CertificateSigningRequest $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheCertificateSigningRequest|mixed
     */
    public function replace($name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Certificates\V1beta1\CertificateSigningRequest $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheCertificateSigningRequest|mixed
     */
    public function replaceApproval($name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Certificates\V1beta1\CertificateSigningRequest $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
     ...
     * @return TheCertificateSigningRequest|mixed
     */
    public function replaceStatus($name, \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Apis\Certificates\V1beta1\CertificateSigningRequest $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
