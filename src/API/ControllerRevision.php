...
use \Kubernetes\Model\Io\K8s\Api\Apps\V1beta1\ControllerRevision as TheControllerRevision;
...
class ControllerRevision extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Api\Apps\V1beta1\ControllerRevision $Model)
    {
        return $this->parseResponse(
     ...
     * @return TheControllerRevision|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1beta1\ControllerRevision $Model)
    {
        return $this->parseResponse(
