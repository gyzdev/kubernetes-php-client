...
class ResponseTypes
{
    ...
    const TYPES = [
        ...
        'listAdmissionregistrationV1alpha1ExternalAdmissionHookConfiguration' => [
            '200.' => '\\Kubernetes\\Model\\Io\\K8s\\Api\\Admissionregistration\\V1alpha1\\ExternalAdmissionHookConfigurationList',
        ],
        'createAdmissionregistrationV1alpha1ExternalAdmissionHookConfiguration' => [
            '200.' => '\\Kubernetes\\Model\\Io\\K8s\\Api\\Admissionregistration\\V1alpha1\\ExternalAdmissionHookConfiguration',
        ],
