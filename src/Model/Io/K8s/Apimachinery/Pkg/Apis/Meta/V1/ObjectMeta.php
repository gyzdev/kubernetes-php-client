...
class ObjectMeta extends \Kubernetes\AbstractModel
{
     ...
     * after the time in this field. Once set, this value may not be unset or be set
     ...
     * deleted in 30 seconds. The Kubelet will react by sending a graceful termination
     * signal to the containers in the pod. After that 30 seconds, the Kubelet will
     * send a hard termination signal (SIGKILL) to the container and after cleanup,
     * remove the pod from the API. In the presence of network partitions, this object
     * may still exist after this timestamp, until an administrator or automated
