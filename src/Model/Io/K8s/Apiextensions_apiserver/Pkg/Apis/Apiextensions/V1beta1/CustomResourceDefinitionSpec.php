...
class CustomResourceDefinitionSpec extends \Kubernetes\AbstractModel
{
    ...
    /**
     * Validation describes the validation methods for CustomResources This field is
     * alpha-level and should only be sent to servers that enable the
     * CustomResourceValidation feature.
     *
