...
class PodAffinity extends \Kubernetes\AbstractModel
{
     ...
     * affinity requirements specified by this field are not met at scheduling time,
     * the pod will not be scheduled onto the node. If the affinity requirements
     * specified by this field cease to be met at some point during pod execution (e.g.
     * due to a pod label update), the system will try to eventually evict the pod from
