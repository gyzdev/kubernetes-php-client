...
class ScaleIOVolumeSource extends \Kubernetes\AbstractModel
{
    ...
    /**
     * The name of the Protection Domain for the configured storage (defaults to
     * "default").
     *
     * @var string
     */
    ...
    /**
     * Indicates whether the storage for a volume should be thick or thin (defaults to
     * "thin").
     *
     * @var string
     */
