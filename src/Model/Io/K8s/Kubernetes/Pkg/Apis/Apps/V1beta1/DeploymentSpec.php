...
class DeploymentSpec extends \Kubernetes\AbstractModel
{
     ...
     * be surfaced in the deployment status. Once autoRollback is implemented, the
     * deployment controller will automatically rollback failed deployments. Note that
     * progress will not be estimated during the time a deployment is paused. Defaults
     * to 600s.
     *
     * @var integer
     */
    ...
    /**
     * The config this deployment is rolling back to. Will be cleared after rollback is
     * done.
     *
     * @var RollbackConfig
     */
     ...
     *
     * @var \Kubernetes\Model\Io\K8s\Kubernetes\Pkg\Api\V1\PodTemplateSpec
     */
