 ...
 * node whose value of the label with key <topologyKey> tches that of any node on
...
class PodAffinityTerm extends \Kubernetes\AbstractModel
{
     ...
     * running. For PreferredDuringScheduling pod anti-affinity, empty topologyKey is
     * interpreted as "all topologies" ("all topologies" here means all the
     * topologyKeys indicated by scheduler command-line argument --failure-domains);
     * for affinity and for RequiredDuringScheduling pod anti-affinity, empty
